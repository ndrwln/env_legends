this.legend_southern_scarf_wrap <- this.inherit("scripts/items/legend_armor/legend_armor_cloak", {
	function create()
	{
		this.legend_armor_cloak.create();
		this.m.ID = "legend_armor.body.legend_southern_scarf_wrap";
	...
	function updateVariant()
	{
		...
		this.m.SpriteBack = "bust_southern_scarf_wrap" + "_" + variant;
		this.m.SpriteDamagedBack = "bust_southern_scarf_wrap" + "_" + variant + "_damaged";
		this.m.SpriteCorpseBack = "bust_southern_scarf_wrap" + "_" + variant + "_dead";
