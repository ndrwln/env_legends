this.legend_southern_tabard <- this.inherit("scripts/items/legend_armor/legend_armor_tabard", {
	function create()
	{
		this.legend_armor_tabard.create();
		this.m.ID = "legend_armor.body.legend_southern_tabard";
	...
	function updateVariant()
	{
		...
		this.m.SpriteBack = "bust_southern_tabard" + "_" + variant;
		this.m.SpriteDamagedBack = "bust_southern_tabard" + "_" + variant + "_damaged";
		this.m.SpriteCorpseBack = "bust_southern_tabard" + "_" + variant + "_dead";
