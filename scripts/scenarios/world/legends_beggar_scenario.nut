this.legends_beggar_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnAssets()
	{
		...
		{
			local bro;
			bro = this.roster.create("scripts/entity/tactical/player");
		...
		this.bro.setStartValuesEx([
			"legend_beggar_commander_background"
		]);
		this.bro.getSkills().add(this.new("scripts/skills/traits/player_character_trait"));
		this.bro.getFlags().set("IsPlayerCharacter", true);
		this.bro.worsenMood(1.5, "Saw something awful");
