this.legend_armor_scale_coat_named <- this.inherit("scripts/items/legend_armor/legend_named_armor_upgrade", {
	...
	function updateVariant()
	{
		...
		this.m.Icon = "legend_armor/icon_legend_scale_coat_named" + "_" + variant + ".png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "legend_armor/icon_legend_scale_coat_named" + "_" + variant + ".png";
		this.m.OverlayIconLarge = "legend_armor/inventory_legend_scale_coat_named" + "_" + variant + ".png";
	}
