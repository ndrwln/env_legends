this.cultist_vs_uneducated_event <- this.inherit("scripts/events/event", {
	...
	function onUpdateScore()
	{
		...
		foreach( bro in brothers )
		{
			...
			else if (bro.getBackground().isBackgroundType(this.Const.BackgroundType.Lowborn) && !bro.getSkills().hasSkill("trait.bright") || !bro.getBackground().isBackgroundType(this.Const.BackgroundType.Noble) && bro.getSkills().hasSkill("trait.dumb") || bro.getSkills().hasSkill("injury.brain_damage"))
			{
